...
import { postComments } from "@/lib/actions";
    ...
    <div className="space-y-[20px] md:space-y-[26px]">
      ...
      {activeTab === "DOCS" && (
        <div className="space-y-6 sm:space-y-10">
          <div className="space-y-4 px-[78px] text-[#708090] font-normal leading-[18px] text-[13px]">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
              enim ad minim veniam, quis nostrud exercitation ullamco laboris
      ...
      {activeTab === "PHOTOS" && (
        <div className="flex flex-col items-center justify-center py-10 px-6">
          {otherImage ? (
            <div className="w-full max-w-[600px] rounded-[20px] overflow-hidden border border-[#E8EDF2] bg-white shadow-[0px_4px_20px_rgba(31,42,68,0.08)]">
              <img
                src={otherImage}
                alt="Property photos"
