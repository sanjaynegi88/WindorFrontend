...
import { UserPlus, Loader2, ShieldCheck, Mail, User, Lock, EyeOff, Eye } from 'lucide-react';
...
export default function AddCityUserPage() {
    ...
    const onSubmit = async (values: StaffFormValues) => {
        ...
        toast.success(`Staff user "${values.firstName} ${values.lastName}" added successfully!`);
        router.push('/city-users');
    };
                        ...
                        <CardHeader className="border-b justify-center bg-muted/20 py-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <CardDescription>
                                        Create a new city staff account.
                                    </CardDescription>
                                </div>
                            </div>
                        </CardHeader>
