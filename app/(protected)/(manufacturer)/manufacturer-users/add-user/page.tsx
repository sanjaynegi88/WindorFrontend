...
export default function AddContractorStaffPage() {
  ...
  const onSubmit = async (values: StaffFormValues) => {
    ...
    toast.success(
      `Manufacturer staff "${values.firstName} ${values.lastName}" added successfully!`,
    );
    router.push("/manufacturer-users");
  };
            ...
            <CardHeader className="border-b justify-center bg-muted/20 py-4">
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <CardDescription>
                    Create a new contractor staff account.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
