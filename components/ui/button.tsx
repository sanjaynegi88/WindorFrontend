  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'text-accent-foreground border border-input hover:bg-accent data-[state=open]:bg-accent',
        dashed:
          'text-accent-foreground border border-input border-dashed hover:bg-accent hover:text-accent-foreground data-[state=open]:text-accent-foreground',
        ghost:
      ...
      mode: {
        ...
        input: `
            justify-start font-normal hover: [&_svg]:transition-colors [&_svg]:hover:text-foreground data-[state=open]: 
            focus-visible:border-ring focus-visible:outline-hidden focus-visible:ring-ring/30 
