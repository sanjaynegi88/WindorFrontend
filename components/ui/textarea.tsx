...
const textareaVariants = cva(
  `
    w-full border border-input text-foreground shadow-xs shadow-black/5 transition-[color,box-shadow] 
    text-foreground placeholder:text-[#1F2A44]/50 focus-visible:border-ring focus-visible:outline-none 
