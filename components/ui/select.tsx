...
const selectTriggerVariants = cva(
  `
    flex bg-white w-full items-center justify-between outline-none border border-[rgba(112,128,144,0.23)] transition-[color,box-shadow] 
    text-[#1F2A44] data-placeholder:text-[#708090]/50 font-asap font-medium
    focus-visible:border-[#1CA7A6] focus-visible:ring-[#1CA7A6]/30
  ...
  `,
  {
    variants: {
      size: {
        ...
        md: 'h-[46px] md:h-[65px] px-[15px] md:px-[19px] text-[14px] md:text-[20px] leading-[23px] gap-1',
