...
export function EditSubUserForm({ id, route, roleLabel }: EditSubUserFormProps) {
  ...
  const onSubmit = async (values: UserFormValues) => {
    ...
    try {
      ...
      const result = await editStaff(id, formData);
      if (result && !result.success) {
        toast.error(result.message || "Failed to update user");
        return;
      }
      toast.success(`${roleLabel} staff updated successfully!`);
      router.push(route);
    } catch (error: any) {
            ...
            <CardHeader className="border-b justify-center bg-muted/20 py-4">
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <CardDescription>
                    Update {roleLabel.toLowerCase()} staff information and profile.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
